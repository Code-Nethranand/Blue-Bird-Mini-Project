...
(41, 'XYZ', 'xyz@gmail.com', 'Single Room', 'Single', 1, '2024-03-08', '2024-03-10', 1, 1000.00, 10.00, 'Room only', 0.00, 1010.00);
...
(41, 'XYZ', 'xyz@gmail.com', 'India', '9874563210', 'Single Room', 'Single', 'Room only', '1', '2024-03-08', '2024-03-10', 1, 'Confirm');
...
CREATE PROCEDURE `add_employee_login` (
    IN p_Emp_Email VARCHAR(50),
    IN p_Emp_Password VARCHAR(50)
)
BEGIN
    -- Insert into emp_login table
    INSERT INTO emp_login (Emp_Email, Emp_Password)
    VALUES (p_Emp_Email, p_Emp_Password);
END //
